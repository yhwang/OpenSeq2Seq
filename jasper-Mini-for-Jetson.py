...
train_params = {
    ...
    "data_layer_params": {
        ...
        "dataset_files": [
            "/home/ubuntu/data/librivox-train-clean-100.csv",
            "/home/ubuntu/data/librivox-train-clean-360.csv",
            "/home/ubuntu/data/librivox-train-other-500.csv",
        ],
        "max_duration": 16.7,
        "shuffle": True,
    },
...
eval_params = {
    ...
    "data_layer_params": {
        "dataset_files": [
            "/home/ubuntu/data/librivox-dev-clean.csv",
        ],
        "shuffle": False,
    },
}
...
infer_params = {
    ...
    "data_layer_params": {
        "dataset_files": [
            "/home/ubuntu/data/librivox-test-clean.csv",
        ],
        "shuffle": False,
    },
}
